...
<body onload="doLogout(); return false;">
   ...
   <input type="text" class="form-control col-sm-6"  name="last_name" style="font-size:17px; font-weight:bold;" placeholder="Last Name" pattern="[A-Za-z]{1,32}" title="Only characters" required>
              ...
              <input type="text" class="form-control" name="nationality" style="font-size:17px; font-weight:bold;" placeholder="Nationality" pattern="[A-Za-z]{1,16}" title="Required" required>
                        </div>
     ...
     <input type="text" class="form-control" name="identity_number" style="font-size:17px; font-weight:bold;" placeholder="Identity Number" pattern="[0-9]{8}" title="Only Numbers" required>
                            <br>
                        </div>
   ...
   <input type="text" class="form-control col-sm-2" name="country_code" style="font-size:14px; font-weight:bold;" placeholder="Country Code" pattern="[A-Za-z]{1,16}" title="Required" required>
   ...
   <input type="text" class="form-control col-sm-3" name="street" style="font-size:14px; font-weight:bold;" placeholder="Street" pattern="[A-Za-z]{1,16}" title="Characters " required>
   ...
   <input type="text" class="form-control col-sm-2" name="post_code" style="font-size:14px; font-weight:bold;" placeholder="Post Code" pattern="[0-9]{1,16}" title="Only Numbers" required>
    ...
    <input type="text" class="form-control col-sm-5" name="tax_residence" style="font-size:17px; font-weight:bold;" placeholder="Recidence" pattern="[A-Z]{1,32}" title="Only uppercase" >
    <input type="text" class="form-control col-sm-7" name="tax_id_number" style="font-size:17px; font-weight:bold;" placeholder="ID Number" pattern="[0-9]{1,32}" title="Only Numbers" >
                         <br><br>
                        </div>
